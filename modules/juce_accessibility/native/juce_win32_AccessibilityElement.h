...
inline bool isValid (const AccessibilityHandler&);
...
private:
    //==============================================================================
    enum class SiblingNavigationDirection { forwards, backwards };
    const AccessibilityHandler* getSibling (SiblingNavigationDirection direction) const;
    ...
    const int rtid = Random::getSystemRandom().nextInt();
    bool valid = true;
