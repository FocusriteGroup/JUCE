...
Component::~Component()
{
    ...
    if (parentComponent != nullptr)
        ...
        giveAwayKeyboardFocus (currentlyFocusedComponent != this);
    ...
    if (child != nullptr)
    {
        ...
        if (currentlyFocusedComponent == child || child->isParentOf (currentlyFocusedComponent))
        {
            if (sendParentEvents)
            {
                ...
                giveAwayKeyboardFocus (sendChildEvents || currentlyFocusedComponent != child);
...
void JUCE_CALLTYPE Component::unfocusAllComponents()
{
    if (auto* c = getCurrentlyFocusedComponent())
        c->giveAwayKeyboardFocus (true);
}

void Component::giveAwayKeyboardFocus (bool sendFocusLossEvent)
{
