...
/**
    ...
    If you need custom focus or keyboard focus traversal for a component, you can create a
    subclass of ComponentTraverser that uses your own algorithm, and use
    Component::createFocusTraverser() or Component::createKeyboardFocusTraverser() to create it.
